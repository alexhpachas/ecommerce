                            ...
                            <tr class="hover:bg-gray-200 hover:text-red-600">
                                ...
                                <td class="py-2">
                                    <span class="flex">        
                                        ...
                                        @can('admin.districts.index')
                                            <a href="{{route('admin.cities.show',$city)}}"  class="cursor-pointer w-7 mr-2 bg-blue-500 text-white border rounded-lg p-1 transform hover:text-white hover:bg-blue-700 hover:scale-110">                                        
                                        ...
                                        @endcan                                 
                                         ...
                                         @can('admin.cities.delete')
                                            <div wire:click="$emit('deleteCity',{{$city}})" class="cursor-pointer w-7 mr-2 bg-red-500 text-white border rounded-lg p-1 transform hover:bg-red-700 hover:scale-110">
