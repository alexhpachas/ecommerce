<x-admin-layout>
    ...
    <div class="container py-12">
            ...
            {{-- <section class="grid md:grid-cols-4 gap-6 text-white mb-6">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex justify-end">
                                    @can('admin.orders.show')                                                                            
                                        <a href="{{ route('admin.orders.show', $order) }}">
                                            <div class="cursor-pointer w-7 mr-2  bg-blue-500 text-white border rounded-lg p-1 transform hover:text-white hover:bg-blue-700 hover:scale-110">                                        
