...
class ExcelExportAgotado implements FromView, WithHeadings, WithCustomStartCell, WithTitle, WithStyles, ShouldAutoSize, WithEvents
{
    public function view(): View
    {
        ...
        return view('admin.reporteEXCEL.agotadosexcel',compact('productosAgotados','categoria','subcategoria','marca') );

    }

    /* CABECERA DEL REPORTE */
    public function headings(): array{
        return ["REPORTE DE STOCK AGOTADO "];
    }
